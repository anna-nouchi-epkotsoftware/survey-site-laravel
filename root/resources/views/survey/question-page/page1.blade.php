    ...
    <div class="row my-4">
        <form method="post" action="{{ route('housing-loan.question-page.page1.postPage1') }}">
            ...
            <div class="container-fluid p-0 mt-2 mb-4">
                <div class="row">
                    <div class="col">
                        <input type="radio" name="usage_situation" value="1" id="usage_situation1" {{ session('form.page1')==1 ? 'checked' : '' }}>
                        <label for="usage_situation1" class="btn btn-outline-info w-100">借りている</label>
                    </div>
                    <div class="col">
                        <input type="radio" name="usage_situation" value="2" id="usage_situation2" {{ session('form.page1')==2 ? 'checked' : '' }}>
                        <label for="usage_situation2" class="btn btn-outline-info w-100">借りていたが、もう返済が終わった</label>
                    </div>
                    <div class="col">
                        <input type="radio" name="usage_situation" value="3" id="usage_situation3" {{ session('form.page1')==3 ? 'checked' : '' }}>
